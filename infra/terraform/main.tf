...
resource "aws_subnet" "public" {
  ...
  tags = { Name = "${var.project_name}-public-${count.index}", Project = var.project_name }
}
...
resource "aws_security_group" "ecs" {
  ...
  tags = { Name = "${var.project_name}-ecs-sg", Project = var.project_name }
}
